...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'office.fictional': 'fictional office',
    'office.keys':
      'Up/Down — choose   ·   Enter / A — read   ·   Esc / B — leave   ·   G — plain text version',
    'map.title': 'DUBAI',
    'map.subtitle': 'a stylised strip, not a survey map · north-east to south-west',
    'map.here': 'Here: {offices}',
    'map.nothing': 'No desk in this area yet.',
    'map.objective': '★ your next step is here',
    'map.keys': 'Left/Right — choose   ·   Enter / A — travel here   ·   Esc / B — back',
    'overlay.title': 'Walk the city',
    'overlay.hint': 'Arrows or WASD to walk · E at a door · Esc to step back',
    'overlay.close': 'Close',
    'overlay.note': 'Unofficial guide — every office in here is fictional.',
    'overlay.noteMore': 'Each answer still carries the official source it came from.',
    'overlay.readInstead': 'Prefer to read?',
    'overlay.yourPath': 'Your path',
    'overlay.and': 'and the',
    'overlay.plainGuide': 'plain guide',
    'overlay.sameContent': 'hold exactly the same content.',
    'overlay.failed': 'The city could not start in this browser. Nothing is lost — every answer it contains is also written out on your path and in the plain guide.',
  },
  ...
  ar: {
    ...
    'office.fictional': 'مكتب خيالي',
    'office.keys':
      'أعلى/أسفل — للاختيار   ·   Enter أو A — للقراءة   ·   Esc أو B — للخروج   ·   G — النسخة النصية',
    'map.title': 'دبي',
    'map.subtitle': 'شريط تمثيلي مبسّط، وليس خريطة مساحية · من الشمال الشرقي إلى الجنوب الغربي',
    'map.here': 'هنا: {offices}',
    'map.nothing': 'لا يوجد مكتب في هذه المنطقة بعد.',
    'map.objective': '★ خطوتك التالية هنا',
    'map.keys': 'يمين/يسار — للاختيار   ·   Enter أو A — للانتقال   ·   Esc أو B — للرجوع',
    'overlay.title': 'تجوّل في المدينة',
    'overlay.hint': 'الأسهم أو WASD للمشي · E عند الباب · Esc للرجوع',
    'overlay.close': 'إغلاق',
    'overlay.note': 'دليل غير رسمي — كل مكتب هنا خيالي.',
    'overlay.noteMore': 'وتبقى كل إجابة مصحوبة بمصدرها الرسمي.',
    'overlay.readInstead': 'تفضّل القراءة؟',
    'overlay.yourPath': 'مسارك',
    'overlay.and': 'و',
    'overlay.plainGuide': 'الدليل النصي البسيط',
    'overlay.sameContent': 'يحتويان المحتوى نفسه تمامًا.',
    'overlay.failed': 'تعذّر تشغيل المدينة في هذا المتصفح. لم يُفقد شيء — كل إجابة فيها مكتوبة أيضًا في مسارك وفي الدليل النصي البسيط.',
  },
};
